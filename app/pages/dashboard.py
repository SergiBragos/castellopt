    ...
    return app_layout(
        rx.box(
            ...
            rx.hstack(
                ...
                stat_card("Posicions", AppState.dades_castell_actiu.num_castellers),
                ...
                rx.table.root(
                    ...
                    rx.table.body(
                        ...
                        rx.table.row(
                            ...
                            rx.table.cell(rx.box(rx.text("Processing...", **styles.badge_info))),
                        ),
                        rx.table.row(
                            ...
                            rx.table.cell(rx.box(rx.text("Error", **styles.badge_warning))),
                        ),
                    ),
                    width="100%",
                ),
